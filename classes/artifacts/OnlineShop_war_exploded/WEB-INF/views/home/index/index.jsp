                      ...
                      <div id="xifan_bd1lfimg" style="width:780px;height:350px;">
                        <div >
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/4.jpg" alt="想不出名字队的软件工程课设"></a></dt>
                            <dd><h2><a href="" target="_blank">双十二大促销</a></h2></dd>
                          </dl>
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/4.jpg" alt="想不出名字队的软件工程课设"></a></dt>
                            <dd><h2><a href="" target="_blank">双十二大促销</a></h2></dd>
                          ...
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/5.jpg" alt="想不出名字队的软件工程课设"></a></dt>
                            <dd><h2><a href="" target="_blank">圣诞快乐</a></h2></dd>
                          </dl>
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/6.jpg" alt="想不出名字队的软件工程课设"></a></dt>
                            <dd><h2><a href="" target="_blank">欢庆元旦</a></h2></dd>
                          </dl>
                        </div>
                      </div>
                    </div>
